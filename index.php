    ...
    <section class="about py-lg-5 py-md-5 py-3">
        <div class="container">
                ...
                <div class="fetured-info py-lg-5 py-3">
                    <h3 class="heading text-center mb-lg-5 mb-3"> Our Services </h3>
                    <div class="row fetured-sec mt-lg-5">
                            ...
                            <div class="featured-left text-center row">
                                <div class="col-sm-6">
                                    <div class="bottom-gd fea">
                                        ...
                                        <p class="px-lg-3">Indonesia merupakan negara yg memiliki banyak objek pariwisata untuk dikunjungi, baik wisata alam maupun buatannya. </p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="bottom-gd fea">
                                        <!-- <h3 class="my-3"> Integer Pulvinar</h3> -->
                                        <p class="px-lg-3">Khususnya di Bali, Bali dinobatkan sebagai destinasi wisata terbaik di dunia versi TripAdvisor</p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="bottom-gd fea">
                                        <!-- <h3 class="my-3">Integer Pulvinar</h3> -->
                                        <p class="px-lg-3">Restu Adi Travel adalah sebuah jasa di bidang biro perjalanan wisata yg menawarkan pakrt tur khusus bali</p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="bottom-gd fea">
                                        <!-- <h3 class="my-3">Integer Pulvinar</h3> -->
                                        <p class="px-lg-3">	Bali merupakan destinasi wisata yg tidak terlewatkan dari list kalian, maka itu kami disini menyediakan
                        ...
                        <div class="col-lg-6">
                            <img src="images/header-background.jpg" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
                <!-- //services -->
            ...
            <div class="row">
                <div class="col-lg-6 testimonials_grid">
                    <div class="bg-white rounded p-lg-5 p-3">
                        <p class="sub-test"><span class="fa fa-quote-left" aria-hidden="true"></span> The Arragment of this tour was very good especialy,the Tour Leader and Local Guide made us comfortable, we were so happy.
                        </p>
                        <div class="row mt-4">
                ...
                <div class="col-lg-6 testimonials_grid mt-lg-0 mt-4">
                    <div class="bg-white rounded p-lg-5 p-3">
                        <p class="sub-test"><span class="fa fa-quote-left" aria-hidden="true"></span> Totally recommend this agency. everhingwent smoothly and we had no problem. thank you Restu Adi Travel you always be my choose travel to bali
                        </p>
                        <div class="row mt-4">
                            <div class="col-3 testi-img-res">
